Kassi::Application.routes.draw do
  ...
  scope "(/:locale)", :constraints => {:locale => locale_matcher} do
    ...
    namespace :admin do
      ...
      post "/stripe_preferences/preferences_update" => "stripe_preferences#preferences_update"
      get "/stripe_preferences/account_create" => "stripe_preferences#account_create"
      get "/stripe_preferences/permissions_verified" => "stripe_preferences#permissions_verified"
      ...
      resources :communities do
        ...
        resource :stripe_preferences, only: :index do
          ...
          member do
            get :index, to: redirect("/admin/paypal_preferences")
            post :preferences_update # POST request, no redirect
            get :account_create, to: redirect("/admin/stripe_preferences/account_create")
            get :permissions_verified, to: redirect("/admin/stripe_preferences/permissions_verified")
          end
        end
      end
